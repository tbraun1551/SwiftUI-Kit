...
//enum Categories: String, CaseIterable, Identifiable, CustomStringConvertible, {
//    case communications, weather, objectsAndTools, devices, connectivity, transportation, human, nature, editing, textFormatting, media, keyboard, commerce, time, health, shapes, arrows, indices, math
//
//
//
...
//    }
//}
let categories: [[String]] = [communications, weather, objectsAndTools, devices, connectivity, transportation, human, nature, editing, textFormatting, media, keyboard, commerce, time, health, shapes, arrows, indices, math]
let categoryNames = ["Communications", "Weather", "Objects & Tools", "Devices", "Connectivity", "Transportation", "Human", "Nature", "Editing", "Text Formatting", "Media", "Keyboard", "Commerce", "Time", "Health", "Shapes", "Arrows", "Indices", "Math"]
